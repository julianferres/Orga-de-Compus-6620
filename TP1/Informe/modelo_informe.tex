...
\begin{itemize}
	...
	\texttt{root@:~\# mkdir TP1NetBSD}
	
	\texttt{root@:~\# cd TP1NetBSD}
	
	\texttt{root@:~/TP1NetBSD/TP1\# gcc -Wall -O0 -S -mrnames *.c}
	...
	\texttt{hostOS\# scp -P2222 root@127.0.0.1:/root/TP1NetBSD/TP1/*.s /home/user}
\end{itemize}
